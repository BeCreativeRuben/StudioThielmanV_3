  ...
  return (
    <div>
      <section className="relative py-20 md:py-32 overflow-hidden -mt-20 pt-20">
        ...
        >
          <div className="text-sm text-white/60 uppercase tracking-wider mb-4">{a.hero.label}</div>
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">{a.hero.title}</h1>
          <p className="text-xl text-white/80 max-w-2xl mx-auto">{a.hero.subtitle}</p>
        </motion.div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="text-sm text-text-secondary uppercase tracking-wider mb-4">{a.founder.label}</div>
            <h2 className="text-4xl md:text-5xl font-bold text-primary mb-8">{a.founder.name}</h2>
            <div className="space-y-6 text-body-lg text-text-primary max-w-3xl mx-auto">
              {a.founder.paragraphs.map((paragraph, index) => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="text-sm text-text-secondary uppercase tracking-wider mb-4">{a.teamSection.label}</div>
            <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4">{a.teamTitle}</h2>
            <p className="text-body-lg text-text-primary max-w-2xl mx-auto">{a.teamSection.subtitle}</p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="text-sm text-text-secondary uppercase tracking-wider mb-4">{a.valuesSection.label}</div>
            <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4">{a.valuesSection.title}</h2>
            <p className="text-body-lg text-text-primary max-w-2xl mx-auto">{a.valuesSection.subtitle}</p>
          </motion.div>
              ...
              >
                <div className="bg-white border border-gray-200 rounded-xl p-6 h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className="w-12 h-12 bg-cta/10 rounded-lg flex items-center justify-center mb-4 text-cta group-hover:bg-cta group-hover:text-white transition-all duration-300">
                    <div className="flex-shrink-0 w-6 h-6">{valueIcons[index]}</div>
                  </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">{a.cta.title}</h2>
            <p className="text-lg text-white/80 mb-8">{a.cta.subtitle}</p>
