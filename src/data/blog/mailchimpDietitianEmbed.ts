export const mailchimpDietitianEmbedNl = `<div id="mc_embed_shell">
...
<div hidden=""><input type="hidden" name="tags" value="6666259"></div>
...
export const mailchimpDietitianEmbedEn = mailchimpDietitianEmbedNl.replace(
  'Blijf op de hoogte van het boekhoudplatform voor diëtisten!',
  'Stay updated on our accounting platform for dietitians!',
)
